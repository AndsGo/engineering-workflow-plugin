...
```
Phase 1: Read docs/learnings/ for relevant prior context
...
├── YYYY-MM-DD-bug-*.md            # Bug root causes and fixes
├── YYYY-MM-DD-pattern-*.md        # Reusable patterns
├── YYYY-MM-DD-architecture-*.md   # Design decisions
